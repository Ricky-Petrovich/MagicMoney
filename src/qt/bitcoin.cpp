...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. The MagicMoney client can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "MIM:", 7) == 0)
        {
    ...
    app.setOrganizationName("MagicMoney");
    app.setOrganizationDomain("MagicMoney.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("MagicMoney-Qt-testnet");
    else
        app.setApplicationName("MagicMoney-Qt");
