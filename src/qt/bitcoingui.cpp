...
{
    resize(850, 550);
    setWindowTitle(tr("Magic Money Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MagicMoney address"));
    ...
    aboutAction->setToolTip(tr("Show information about MagicMoney"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for MagicMoney"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &MagicMoney"), this);
    toggleHideAction->setToolTip(tr("Show or hide the MagicMoney window"));
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/MIM_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/MIM_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MagicMoney wallet"));
    ...
    notificator = new Notificator(tr("MagicMoney-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MagicMoney network", "", count));
}
