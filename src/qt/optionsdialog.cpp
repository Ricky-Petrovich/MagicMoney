        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start MagicMoney client on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start MagicMoney client after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the MagicMoney client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show MagicMoney addresses in the transaction list"));
