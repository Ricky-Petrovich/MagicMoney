...
static const int COINBASE_MATURITY_PPC = 30;
...
static const int STAKE_TARGET_SPACING = 240; // 4-minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60; // minimum age for coin age
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 366; // stake age of full weight
